...
void main() {
  ...
  // http.post(
  //   Uri.https(constants.host),
  //   headers: {
  //     "Authorization": 'Basic ${base64Encode(utf8 .encode('user:psk01111'))}',
  //   },
  //   body: jsonEncode({
  //     "method": "get",
  //     "path": "disc",
  //   }),
  // ).then((res) => print("${res.body},${res.statusCode}"));
  ...
  Widget build(BuildContext context) {
    return LifecycleWrapper(
      onLifecycleEvent: (event) {
        if (event == LifecycleEvent.pop) Process.killPid(Data().pid);
      },
      child: MaterialApp(
        title: 'Assignment',
        theme: ThemeData(
